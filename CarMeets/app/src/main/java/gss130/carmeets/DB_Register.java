...
//register a new user
//into the database
public class DB_Register extends AsyncTask {
   ...
   // private String Car = "";
    ...
    //Constructor
    public DB_Register(String link, String username, String password, String location, String age, String preferences, String availability, String car_info, String gender, String email) {
    ...
    protected String doInBackground(Object[] params) {
        try {
            ...
            data += "&" + URLEncoder.encode("age", "UTF8") + "=" + URLEncoder.encode(String.valueOf(Age), "UTF8");
            ...
            //variable in Register activity
            Register.reg = sb.toString();
        } catch (Exception e) {}
        return "";
    }
}
